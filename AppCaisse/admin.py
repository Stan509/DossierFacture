...
from .models import Facture, Dette, Comptabilite, ResultatCalcul, EntreeParDate, MontantParDate, CashParJour
...
@admin.register(MontantParDate)
class MontantParDateAdmin(admin.ModelAdmin):
    list_display = ('id', 'montant', 'date')

@admin.register(EntreeParDate)
class EntreeParDateAdmin(admin.ModelAdmin):
    list_display = ('id', 'montant_total', 'date')

@admin.register(CashParJour)
class CashParJourAdmin(admin.ModelAdmin):
    list_display = ('id', 'difference_cash', 'date')
